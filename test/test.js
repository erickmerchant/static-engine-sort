...
describe('plugin', function(){
    ...
    describe('title', function(){
        ...
        it('it should sort titles in alphabetical order', function(done){
            ...
            sort.title([{ title: 'réservé' }, { title: 'premier' }, { title: 'cliché' }, { title: 'communiqué' }, { title: 'café' }, { title: 'adieu' }], function(err, pages){
    ...
    describe('date', function(){
        ...
        it('it should sort dates newest to oldest', function(done){
            ...
            sort.date([{date: moment('20120101', 'YYYYMMDD')}, {date: moment('20110101', 'YYYYMMDD')}, {date: moment('20130101', 'YYYYMMDD')}], function(err, pages){
